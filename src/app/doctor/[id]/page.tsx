    ...
    <div className="min-h-[100dvh] bg-transparent font-sans pb-24 relative overflow-hidden">
      ...
      <header className="md:hidden flex justify-between items-center p-6 bg-transparent absolute top-0 left-0 right-0 z-10">
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <Image src={`${(process.env.NEXT_PUBLIC_BASE_PATH && process.env.NEXT_PUBLIC_BASE_PATH != "undefined") ? process.env.NEXT_PUBLIC_BASE_PATH : ""}/logo.png`} alt="MedBook Logo" width={120} height={32} className="h-6 md:h-8 object-contain drop-shadow-md" />
