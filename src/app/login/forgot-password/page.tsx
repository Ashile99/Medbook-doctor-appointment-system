      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl shadow-primary/5 border border-border-color/30 w-full max-w-lg overflow-hidden p-8 sm:p-12 flex flex-col justify-center">
        <div className="mb-10 text-center">
          <Link href="/" className="inline-block mb-8">
            <Image src={`${(process.env.NEXT_PUBLIC_BASE_PATH && process.env.NEXT_PUBLIC_BASE_PATH != "undefined") ? process.env.NEXT_PUBLIC_BASE_PATH : ""}/logo.png`} alt="MedBook" width={160} height={40} className="h-8 w-auto mx-auto" />
          </Link>
